...
func oneAway(_ first: String, _ second: String) -> Bool {
    ...
    // If the strings are the same length, they are on replacement away.
    // If the strings differ by one, the may be one edit or insert away.
...
/*
 ...
 Do this by comparing character and pointer.
 ...
 you know they are more than one way.
*/
